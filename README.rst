...
First, I want to recommend this library structure: [your_library](your_library). This script would tried to read title and author from book's metadata, otherwise would tried to parse filename.
